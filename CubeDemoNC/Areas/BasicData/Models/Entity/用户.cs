...
namespace GPSPlatform.BasicData.Entity
{
    ...
    [BindTable("User", Description = "用户。用户帐号信息", ConnName = "VehicleGPSVideo", DbType = DatabaseType.SqlServer)]
    public partial class User
    {
        ...
        [BindColumn("LastLogin", "最后登录", "datetime", Precision = 0, Scale = 3)]
        ...
        [Description("注册时间")]
        [DataObjectField(false, false, true, 3)]
        [BindColumn("RegisterTime", "注册时间", "datetime", Precision = 0, Scale = 3)]
