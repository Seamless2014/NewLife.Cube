...
namespace GPSPlatform.BackManagement.Entity
{
    public partial class MediaItem : Entity<MediaItem>
    {
        ...
        // Select Count(MediaItemId) as MediaItemId,Category From MediaItem Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By MediaItemId Desc limit 20
        //static readonly FieldCache<MediaItem> _CategoryCache = new FieldCache<MediaItem>(nameof(Category))
        //{
