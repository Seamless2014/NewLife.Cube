...
namespace GPSPlatform.ReportStatistics.Entity
{
    public partial class OnlineRecord : Entity<OnlineRecord>
    {
        ...
        // Select Count(AlarmId) as AlarmId,Category From OnlineRecord Where CreateTime>'2020-01-24 00:00:00' Group By Category Order By AlarmId Desc limit 20
        //static readonly FieldCache<OnlineRecord> _CategoryCache = new FieldCache<OnlineRecord>(nameof(Category))
        //{
