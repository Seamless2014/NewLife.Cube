...
{
    /// <summary>上线记录</summary>
    [Serializable]
    [DataObject]
    [Description("上线记录")]
    [BindTable("OnlineRecord", Description = "上线记录", ConnName = "VehicleGPSVideo", DbType = DatabaseType.SqlServer)]
    public partial class OnlineRecord
    {
        ...
        [Description("驾驶员")]
        [DataObjectField(false, false, true, 55)]
        [BindColumn("Driver", "驾驶员", "nvarchar(55)")]
        ...
        [Description("位置1")]
        [DataObjectField(false, false, true, 255)]
        [BindColumn("Location1", "位置1", "nvarchar(255)")]
        ...
        [Description("视频文件名称")]
        [DataObjectField(false, false, true, 55)]
        [BindColumn("VideoFileName", "视频文件名称", "nvarchar(55)")]
        ...
        [Description("标识")]
        [DataObjectField(false, false, true, 55)]
        [BindColumn("Flag", "标识", "nvarchar(55)")]
        ...
        #region 字段名
        /// <summary>取得上线记录字段信息的快捷方式</summary>
        ...
        /// <summary>取得上线记录字段名称的快捷方式</summary>
