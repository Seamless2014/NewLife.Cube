...
namespace VehicleVedioManage.FenceManagement.Entity
{
    ...
    [DataObject]
    [Description("定制标记")]
    [BindIndex("IU_CustomMarker_Name", true, "Name")]
    [BindTable("CustomMarker", Description = "定制标记", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
