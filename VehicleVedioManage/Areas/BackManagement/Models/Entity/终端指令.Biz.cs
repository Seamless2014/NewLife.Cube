...
{
    public partial class TerminalCommand : Entity<TerminalCommand>
    {
        #region 对象操作
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化TerminalCommand[终端指令]数据……");

        //    var entity = new TerminalCommand();
        //    entity.PlateNo = "abc";
        //    entity.CmdType = 0;
        //    entity.Cmd = "abc";
        //    entity.CmdData = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化TerminalCommand[终端指令]数据！");
        //}
        ...
        public static TerminalCommand FindByCmdId(Int32 cmdId)
        {
