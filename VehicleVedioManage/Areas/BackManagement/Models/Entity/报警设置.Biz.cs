...
{
    public partial class AlarmConfig : Entity<AlarmConfig>
    {
        #region 对象操作
        static AlarmConfig()
        {
        ...
        //    entity.popupEnabled = true;
        //    entity.alarmSource = "abc";
        //    entity.statisticEnabled = true;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化AlarmConfig[报警设置]数据！");
        //}
        ...
        /// <summary>报警源</summary>
        [Map(__.alarmSource)]
        public String AlarmSourceName => _AlarmSource?.Name;
        #endregion
