...
namespace VehicleVedioManage.BackManagement.Entity
{
    ...
    [DataObject]
    [Description("终端参数")]
    [BindIndex("IU_TerminalParam_PlateNo", true, "PlateNo")]
    [BindIndex("IX_TerminalParam_SimNo", false, "SimNo")]
    [BindTable("TerminalParam", Description = "终端参数", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
    public partial class TerminalParam
    {
        ...
        #region 字段名
        /// <summary>取得终端参数字段信息的快捷方式</summary>
        ...
        /// <summary>取得终端参数字段名称的快捷方式</summary>
