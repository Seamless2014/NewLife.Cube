...
namespace VehicleVedioManage.BackManagement.Entity
{
    ...
    [DataObject]
    [Description("系统配置")]
    [BindTable("SystemConfig", Description = "系统配置", ConnName = "VehicleGPSVideo", DbType = DatabaseType.SqlServer)]
    public partial class SystemConfig
    {
        ...
        private String _SystemTitle1;
        /// <summary>系统标题1</summary>
        [Category("基本信息")]
        [DisplayName("系统标题1")]
        [Description("系统标题1")]
        [DataObjectField(false, false, true, 255)]
        [BindColumn("SystemTitle1", "系统标题1", "varchar(255)")]
        public String SystemTitle1 { get => _SystemTitle1; set { if (OnPropertyChanging("SystemTitle1", value)) { _SystemTitle1 = value; OnPropertyChanged("SystemTitle1"); } } }
        ...
        [BindColumn("InitZoomLevel", "初始层级", "int")]
        ...
        [BindColumn("MapType", "图商类型", "nvarchar(50)")]
        ...
        /// <summary>智能密钥</summary>
        [Category("基本信息")]
        [DisplayName("智能密钥")]
        [Description("智能密钥")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("SmartKey", "智能密钥", "varchar(50)")]
        ...
        [Description("最大离线天数")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn("MaxOfflineDays", "最大离线天数", "int")]
        ...
        [Description("显示状态类型")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("DisplayStateType", "显示状态类型", "nvarchar(50)")]
        ...
        [Description("百度Key")]
        [DataObjectField(false, false, true, 255)]
        [BindColumn("BaiduKey", "百度Key", "nvarchar(255)")]
        ...
        [Description("阿里Key")]
        [DataObjectField(false, false, true, 255)]
        [BindColumn("AmapKey", "阿里Key", "nvarchar(255)")]
        ...
        [DataObjectField(false, false, true, 255)]
        [BindColumn("AmapWebServiceKey", "阿里Web服务Key", "nvarchar(255)")]
        ...
        [Description("刷新间隔")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn("RefreshInterval", "刷新间隔", "int")]
        ...
        [Description("报警间隔")]
        [DataObjectField(false, false, true, 10)]
        [BindColumn("AlarmInterval", "报警间隔", "int")]
        ...
        private String _ShowVehicleOnMap;
        /// <summary>在地图上显示车辆</summary>
        [Category("扩展信息")]
        [DisplayName("在地图上显示车辆")]
        [Description("在地图上显示车辆")]
        [DataObjectField(false, false, true, 255)]
        [BindColumn("ShowVehicleOnMap", "在地图上显示车辆", "nvarchar(255)")]
        public String ShowVehicleOnMap { get => _ShowVehicleOnMap; set { if (OnPropertyChanging("ShowVehicleOnMap", value)) { _ShowVehicleOnMap = value; OnPropertyChanged("ShowVehicleOnMap"); } } }

        private String _ShowDepNameOnMap;
        /// <summary>在地图上显示部门</summary>
        [Category("扩展信息")]
        [DisplayName("在地图上显示部门")]
        [Description("在地图上显示部门")]
        [DataObjectField(false, false, true, 50)]
        [BindColumn("ShowDepNameOnMap", "在地图上显示部门", "nvarchar(50)")]
        public String ShowDepNameOnMap { get => _ShowDepNameOnMap; set { if (OnPropertyChanging("ShowDepNameOnMap", value)) { _ShowDepNameOnMap = value; OnPropertyChanged("ShowDepNameOnMap"); } } }
        ...
        [DataObjectField(false, false, true, 255)]
        [BindColumn("BaiduWebServiceKey", "百度Web服务Key", "nvarchar(255)")]
        ...
        public override Object this[String name]
        {
            get
            {
                ...
                {
                    case "Id": return _Id;
                    case "SystemTitle1": return _SystemTitle1;
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "SystemTitle1": _SystemTitle1 = Convert.ToString(value); break;
                    ...
                    case "ShowVehicleOnMap": _ShowVehicleOnMap = Convert.ToString(value); break;
                    case "ShowDepNameOnMap": _ShowDepNameOnMap = Convert.ToString(value); break;
        ...
        #region 字段名
        /// <summary>取得SystemConfig字段信息的快捷方式</summary>
        public partial class _
        {
            ...
            /// <summary>系统标题1</summary>
            public static readonly Field SystemTitle1 = FindByName("SystemTitle1");
        ...
        /// <summary>取得SystemConfig字段名称的快捷方式</summary>
        public partial class __
        {
            ...
            /// <summary>系统标题1</summary>
            public const String SystemTitle1 = "SystemTitle1";
