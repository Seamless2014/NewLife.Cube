...
namespace VehicleVedioManage.BackManagement.Entity
{
    ...
    public partial class TerminalInfo
    {
        ...
        [BindColumn("MakeTime", "制造时间", "", Precision = 0, Scale = 3)]
        ...
        [Description("安装时间")]
        [DataObjectField(false, false, true, 0)]
        [BindColumn("InstallTime", "安装时间", "", Precision = 0, Scale = 3)]
        ...
        [BindColumn("InstallAddress", "安装地址", "")]
        ...
        #region 字段名
        /// <summary>取得终端信息字段信息的快捷方式</summary>
        ...
        /// <summary>取得终端信息字段名称的快捷方式</summary>
