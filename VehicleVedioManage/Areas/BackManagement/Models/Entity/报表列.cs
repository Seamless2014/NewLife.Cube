...
namespace VehicleVedioManage.BackManagement.Entity
{
    ...
    [DataObject]
    [Description("报表列")]
    [BindIndex("IU_ReportColumn_Name", true, "Name")]
    [BindTable("ReportColumn", Description = "报表列", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
    public partial class ReportColumn
    {
        ...
        [BindColumn("BasicDataCode", "基础数据编码", "")]
