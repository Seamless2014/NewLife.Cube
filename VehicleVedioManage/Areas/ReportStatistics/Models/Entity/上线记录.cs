...
namespace VehicleVedioManage.ReportStatistics.Entity
{
    ...
    [DataObject]
    [Description("上线记录")]
    [BindIndex("IU_OnlineRecord_PlateNo", true, "PlateNo")]
    [BindIndex("IX_OnlineRecord_PlateNo_StartTime_EndTime", false, "PlateNo,StartTime,EndTime")]
    [BindTable("OnlineRecord", Description = "上线记录", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
