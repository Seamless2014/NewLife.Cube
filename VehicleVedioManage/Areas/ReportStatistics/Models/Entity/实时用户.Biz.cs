...
{
    public partial class UserGpsRealData : Entity<UserGpsRealData>
    {
        #region 对象操作
        static UserGpsRealData()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化UserGpsRealData[用户GPS实时数据]数据……");

        //    var entity = new UserGpsRealData();
        //    entity.UserId = 0;
        //    entity.UserName = "abc";
        //    entity.Accuracy = 0.0;
        //    entity.Location = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化UserGpsRealData[用户GPS实时数据]数据！");
        //}
        ...
        public static UserGpsRealData FindByID(Int32 id)
        {
            if (id <= 0) return null;
