...
{
    /// <summary>历史报警</summary>
    [Serializable]
    [DataObject]
    [Description("历史报警")]
    [BindTable("HisAlarmRecord", Description = "历史报警", ConnName = "VehicleGPSVideo", DbType = DatabaseType.SqlServer)]
    public partial class HisAlarmRecord
    {
        #region 属性
        ...
        #region 字段名
        /// <summary>取得历史报警字段信息的快捷方式</summary>
        ...
        /// <summary>取得历史报警字段名称的快捷方式</summary>
