...
namespace VehicleVedioManage.ReportStatistics.Entity
{
    ...
    [DataObject]
    [Description("历史报警")]
    [BindIndex("IU_HisAlarmRecord_PlateNo", true, "PlateNo")]
    [BindIndex("IX_HisAlarmRecord_PlateNo_StartTime_EndTime", false, "PlateNo,StartTime,EndTime")]
    [BindTable("HisAlarmRecord", Description = "历史报警", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
