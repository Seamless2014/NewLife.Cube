...
namespace VehicleVedioManage.ReportStatistics.Entity
{
    ...
    public partial class FuelConsumption
    {
        ...
        public override Object this[String name]
        {
            ...
            set
            {
                switch (name)
                {
                    ...
                    case "StatisticsDate": _StatisticsDate = value.ToDateTime(); break;
                    case "Fuel": _Fuel = Convert.ToDecimal(value); break;
                    case "IntervalType": _IntervalType = value.ToInt(); break;
                    case "Mileage": _Mileage = Convert.ToDecimal(value); break;
                    case "Gas1": _Gas1 = Convert.ToDecimal(value); break;
                    case "Mileage1": _Mileage1 = Convert.ToDecimal(value); break;
                    ...
                    case "Oil": _Oil = Convert.ToDecimal(value); break;
                    case "Oil1": _Oil1 = Convert.ToDecimal(value); break;
                    case "Oil2": _Oil2 = Convert.ToDecimal(value); break;
        ...
        #region 字段名
        /// <summary>取得燃料消费字段信息的快捷方式</summary>
        ...
        /// <summary>取得燃料消费字段名称的快捷方式</summary>
