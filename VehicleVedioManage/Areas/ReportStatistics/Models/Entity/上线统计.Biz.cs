...
{
    public partial class OnlineStatic : Entity<OnlineStatic>
    {
        #region 对象操作
        static OnlineStatic()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化OnlineStatic[上线统计]数据……");

        //    var entity = new OnlineStatic();
        //    entity.DepId = 0;
        //    entity.DepName = "abc";
        //    entity.OnlineNum = 0;
        //    entity.VehicleNum = 0;
        //    entity.OnlineRate = 0.0;
        //    entity.StatisticDate = DateTime.Now;
        ...
        //    entity.ParentDepId = 0;
        //    entity.StatisticTime = DateTime.Now;
        //    entity.Interval = 0;
        //    entity.Insert();

        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化OnlineStatic[上线统计]数据！");
        //}
        ...
        public String? DepName => _Department?.Name;
        #endregion
        ...
        public static OnlineStatic FindById(Int32 id)
        {
            if (id <= 0) return null;
