...
namespace VehicleVedioManage.ReportStatistics.Entity
{
    ...
    [DataObject]
    [Description("电子运单")]
    [BindIndex("IU_EWayBill_PlateNo", true, "PlateNo")]
    [BindTable("EWayBill", Description = "电子运单", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
