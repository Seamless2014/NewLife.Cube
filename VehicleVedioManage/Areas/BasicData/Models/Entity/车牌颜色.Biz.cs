...
{
    public partial class PlateColor : Entity<PlateColor>
    {
        #region 对象操作
        static PlateColor()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化PlateColor[PlateColor]数据……");

        //    var entity = new PlateColor();
        //    entity.Code = 0;
        //    entity.Name = "abc";
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("完成初始化PlateColor[PlateColor]数据！");
        //}
        ...
        public static PlateColor FindByID(Int32 id)
        {
            if (id <= 0) return null;
