...
{
    public partial class IndustryType : Entity<IndustryType>
    {
        #region 对象操作
        static IndustryType()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化IndustryType[行业类型]数据……");
        ...
        #region 扩展查询
        /// <summary>根据行业类型查找</summary>
        /// <param name="id">行业类型</param>
        /// <returns>实体对象</returns>
        public static IndustryType FindByID(Int32 id)
        {
            if (id <= 0) return null;
