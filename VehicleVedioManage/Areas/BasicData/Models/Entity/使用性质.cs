...
namespace VehicleVedioManage.BasicData.Entity
{
    ...
    [DataObject]
    [Description("使用性质")]
    [BindIndex("IU_UseType_Name", true, "Name")]
    [BindTable("UseType", Description = "使用性质", ConnName = "VehicleGPSVideo", DbType = DatabaseType.None)]
    public partial class UseType
    {
        ...
        #region 字段名
        /// <summary>取得使用性质字段信息的快捷方式</summary>
        ...
        /// <summary>取得使用性质字段名称的快捷方式</summary>
