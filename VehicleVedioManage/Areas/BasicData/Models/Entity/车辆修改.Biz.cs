...
{
    public partial class VehicleInfoModifyRecord : Entity<VehicleInfoModifyRecord>
    {
        #region 对象操作
        static VehicleInfoModifyRecord()
        {
        ...
        //    if (XTrace.Debug) XTrace.WriteLine("开始初始化VehicleInfoModifyRecord[车辆修改记录]数据……");
        ...
        public static VehicleInfoModifyRecord FindByID(Int32 id)
        {
            if (id <= 0) return null;
