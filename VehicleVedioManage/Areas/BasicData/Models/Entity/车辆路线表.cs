...
namespace VehicleVedioManage.BasicData.Entity
{
    ...
    [DataObject]
    [Description("车辆路线表")]
    [BindIndex("PK_VehicleRoute", true, "Id")]
    [BindTable("VehicleRoute", Description = "车辆路线表", ConnName = "VehicleGPSVideo", DbType = DatabaseType.SqlServer)]
    public partial class VehicleRoute
    {
        ...
        #region 字段名
        /// <summary>取得车辆路线表字段信息的快捷方式</summary>
        ...
        /// <summary>取得车辆路线表字段名称的快捷方式</summary>
