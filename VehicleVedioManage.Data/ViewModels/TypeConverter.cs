...
namespace VehicleVedioManage.Data.ViewModels
{
    public class TypeConverter
    {
        ...
        public static int BitToInt(object bit, int defValue)
        {
            if (bit == null) return defValue;
            if (bit.ToString().ToLower() == "true") return 1;
            if (bit.ToString().ToLower() == "false") return 0;
            return StrToInt(bit.ToString(), defValue);
        }
        /// <summary>
        /// string型转换为bool型
        /// </summary>
        ...
        public static decimal StrToDecimal(string strValue, decimal def)
        {
            ...
            {
                XTrace.WriteLine(ex.Message + ex.StackTrace);
                return 0;
            }
        }
        ...
        public static decimal ObjectToDecimal(object strValue, decimal def)
        {
            ...
            return StrToDecimal(strValue.ToString(), def);
        }
        ...
        public static string TimeSpanSub(string str)
        {
            try
            {
                return TimeSpanSub(DateTime.Parse(str));
            }
            catch (Exception ex)
            {
                XTrace.WriteLine(ex.Message + ex.StackTrace);
        ...
        public static string TimeSpanSub(object obj)
        {
            try
            {
                return TimeSpanSub(obj.ToString());
            }
            catch (Exception ex)
            {
                XTrace.WriteLine(ex.Message + ex.StackTrace);
        ...
        public static string TimeSpanSub(DateTime dt)
        {
            ...
            return str.ToString();
            //Response.Write(ts.Days + "天" + ts.Hours + "小时" + ts.Minutes + "分" + ts.Seconds + "秒");
        }
