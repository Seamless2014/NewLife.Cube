...
using XCode.Shards;
using PlateColor = VehicleVedioManage.Data.Entity.PlateColor;
...
namespace VehicleVedioManage.Data.Entity
{
    public partial class JT809Command : Entity<JT809Command>
    {
        ...
        [XmlIgnore, IgnoreDataMember]
        //[ScriptIgnore]
        public PlateColor __PlateColor => Extends.Get(nameof(VehicleVedioManage.Data.Entity.PlateColor), k => VehicleVedioManage.Data.Entity.PlateColor.FindByCode(PlateColor));
