...
namespace VehicleVedioManage.Data.Entity
{
    public partial class WarnMsgUrgTodoReq : Entity<WarnMsgUrgTodoReq>
    {
        ...
        //[ScriptIgnore]
        public PlateColor __PlateColor => Extends.Get(nameof(Data.Entity.PlateColor), k => Data.Entity.PlateColor.FindByCode(PlateColor));
        ...
        public AlarmSource __AlarmSource => Extends.Get(nameof(AlarmSource), k => Data.Entity.AlarmSource.FindByCode(WarnSrc));
