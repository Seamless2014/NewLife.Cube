...
//        public RTPAnalyzer(ITracer tracer, IVehicleService vehicleService)
//        {
//            tracer = tracer;
...
//		{
//			ServiceUtil.VideoRecoderService.Record(SimNo, ChannelId, data, audio);
//		}
...
//					logger.Error(string.Concat(ServerType, ",", RtmpLocation, "释放AMR解码器"));
//				}
//			}
//			catch (Exception ex3)
//			{
...
//			try
//			{
//				ServiceUtil.VideoRecoderService.EndRecord(SimNo, ChannelId);
//			}
//			catch (Exception ex)
//			{
//				tracer.NewError(ex.Message, ex);
...
//			Vehicle vd = ServiceUtil.GetVehicleDataBySimNo(rtp.SimNo);
...
//					videoFileItem.VehicleId = vd.EntityId;
//					videoFileItem.PlateNo = vd.PlateNo;
//					videoFileItem.SimNo = vd.SimNo;
//					videoFileItem.FileSource = VideoFileItem.FROM_SERVER;
...
//					ServiceUtil.BaseDao.saveOrUpdate(videoFileItem);
//				}
//				catch (Exception ex)
//				{
...
//				CloseMp4Hanle();
//				videoFileItem.EndDate = DateTime.Now;
//				videoFileItem.Status = "upload_completed";
...
//						videoFileItem.FileLength = f.Length;
//					}
//				}
//				catch (Exception ex2)
//				{
//					logger.Error("计算mp4文件大小发生错误:" + ex2.Message, ex2);
//					return;
//				}
//				ServiceUtil.BaseDao.saveOrUpdate(videoFileItem);
...
//				ServiceUtil.BaseDao.saveOrUpdate(v);
//			}
//			catch (Exception ex)
//			{
