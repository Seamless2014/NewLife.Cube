...
//		public RtmpTalkback2(string simNo, int channelId)
//		{
//			SimNo = simNo;
//			ChannelId = channelId;
//			audioEncoder = AudioCoder.G711_A;
//		}
...
//				{
//					processRealDataThread.Join(10000);
//				}
//			}
//			catch (Exception ex2)
//			{
...
//				logger.Error("语音对讲：" + RtmpLocation + ",音频编码:" + AudioCoder.GetAudioCoderDescr(audioEncoder) + "," + result);
//				int bufsize = 1024;
...
//						{
//							AutoReconnect();
//							while (continuePull && (nRead = RTMPWrapper.RTMP264_Read(rtmpHandle, ptrBuffer, bufsize)) > 0)
//							{
...
//				logger.Error(ex.Message, ex);
//			}
//			logger.Error("语音对讲：" + RtmpLocation + ",音频编码:" + AudioCoder.GetAudioCoderDescr(audioEncoder) + "退出");
//		}

//		private void EncoderAdpcma(byte[] pcmData)
//		{
//			if (outputAdpcmaIntPtr == IntPtr.Zero)
//			{
...
//			}
//			if (pcmBufferOffset >= AUDIO_ENCODER_BUFFER_SIZE)
//			{
